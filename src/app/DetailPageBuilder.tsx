      ...
      <div style={{ padding: '28px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '12px' }}>
              {TEMPLATES.map((t, i) => (
                <button key={t.id} onClick={() => setSelectedTemplate(i)} style={{
                  ...
                  <div style={{
                    width: '100%', height: '6px', borderRadius: '3px', marginBottom: '10px',
        ...
        {step === 'edit' && (
          <div style={{ display: 'grid', gap: '20px' }}>
            <p style={{ fontSize: '13px', color: 'var(--text-muted)' }}>내용을 수정하세요</p>
            ...
            <div>
              ...
              <textarea rows={6} value={data.description} onChange={e => setData(p => ({ ...p, description: e.target.value }))} style={fieldStyle} />
            </div>
            <div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
              ...
              <div style={{ display: 'flex', gap: '10px' }}>
                ...
                <button onClick={handleDownload} disabled={downloading} style={{
                  background: downloading ? 'var(--surface2)' : 'var(--green)', color: downloading ? 'var(--text-muted)' : '#000',
